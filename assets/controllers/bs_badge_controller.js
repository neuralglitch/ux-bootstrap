...
export default class extends Controller {
    ...
    increment() {
        ...
        console.debug('bs-badge dispatched count-changed event:', {count: this.countValue, action: 'increment'});
    }
    ...
    animate(target, direction) {
        ...
        const step = () => {
            ...
            if (done) {
                ...
                console.debug('bs-badge dispatched animation-complete event:', {count: this.countValue, target});
                return;
            }
